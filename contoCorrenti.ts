class MotherAccount {
  ...
  const addAmountInput = document.getElementById("addAmount") as HTMLInputElement;
  const addButton = document.getElementById("addButton");
  const removeAmountInput = document.getElementById("removeAmount") as HTMLInputElement;
